...
// .wrangler/tmp/bundle-O71S8s/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-O71S8s/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// ../core/src/contentRenewal.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../core/src/productService.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
if (process.env.ENV === "test") {
  import_dotenv.default.config({ path: "tests/.env" });
} else if (process.env.ENV !== "production") {
  import_dotenv.default.config();
}

// ../core/src/productsAuth.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
async function getProductsAuthToken(env2) {
  const url = `${env2.DBM_BASE_URL}${env2.DBM_AUTH_PATH}`;
  const credentials = {
    username: env2.DBM_USERNAME,
    password: env2.DBM_PASSWORD
  };
  try {
    const response = await node_fetch_default(url, {
      method: "POST",
      headers: {
...
__name(getProductsAuthToken, "getProductsAuthToken");

// ../core/src/productService.js
async function fetchProducts(env2) {
  const token = await getProductsAuthToken(env2);
  if (!token) {
    return [];
  }
  const url = `${env2.DBM_BASE_URL}${env2.DBM_PRODUCTS_PATH}`;
  try {
    const response = await node_fetch_default(url, {
      headers: {
        Token: token
...
// ../core/src/reviewsService.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../core/src/reviewsAuth.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
async function getReviewsToken(env2) {
  const username = env2.REVIEWS_USERNAME;
  const url = `${env2.REVIEWS_AUTH_URL}?w=${username}&page=localhost:8080`;
  try {
    const response = await node_fetch_default(url, {
      method: "GET",
      headers: {
...
__name(getReviewsToken, "getReviewsToken");

// ../core/src/reviewsService.js
async function fetchReviews(env2) {
  const token = await getReviewsToken(env2);
  if (!token) {
    return [];
  }
  const storeId = env2.GOOGLE_MAPS_STORE_ID;
  const url = `${env2.REVIEWS_REVIEWS_URL}?uris%5B%5D=${storeId}&filter_content=text_required&min_rating=4&page_length=100&order=date`;
  try {
    const response = await node_fetch_default(url, {
      headers: {
...
// ../core/src/storageService.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
async function fetchJson(fileName, env2) {
  const object = await env2.WEB_BUCKET.get(fileName);
  if (object === null) {
...
async function store(fileName, fileContent, env2) {
  await env2.WEB_BUCKET.put(fileName, fileContent);
  console.log(`Successfully stored file: ${fileName}`);
}
__name(store, "store");

// ../core/src/contentRenewal.js
var defaultContent = { products: [], reviews: [] };
function renewContent(env2) {
  const currentContent = getCurrentContent(env2);
  const updatedProducts = fetchProducts(env2);
  const updatedReviews = fetchReviews(env2);
  const newContent = {
    products: updatedProducts ?? currentContent.products,
    reviews: updatedReviews ?? currentContent.reviews
  };
  storeNewContent(newContent, env2);
  invalidateCache();
}
__name(renewContent, "renewContent");
function getCurrentContent(env2) {
  const contentFileName = env2.CONTENT_FILE_NAME;
  try {
    const currentContentFile = fetchJson(contentFileName, env2);
    return currentContentFile == null ? defaultContent : JSON.parse(currentContentFile);
  } catch (e) {
    console.log("Error trying to get current content", e);
    return defaultContent;
  }
}
__name(getCurrentContent, "getCurrentContent");
function storeNewContent(content, env2) {
  const contentFileName = env2.CONTENT_FILE_NAME;
  store(contentFileName, JSON.stringify(content), env2);
}
__name(storeNewContent, "storeNewContent");
...
var src_default = {
  async fetch(request, env2, ctx) {
    try {
      ctx.waitUntil(renewContent(env2));
